...
(function() {
  var EventEmitter, FileTask, FileTaskSpec, Makelet, Task, TaskSpec, TopLevelTask, async, fileNewerThan, fs, loglet, patsubst, patternFileSubst, patternFiles, patternRootDir, patternToRegex, patternToReplace, utilities, _,
  ...
  FileTask = (function(_super) {
    ...
    FileTask.prototype.addDepends = function(depends) {
      var dependPaths, dependTasks, path, task, _i, _j, _len, _len1, _ref, _ref1, _results;
      dependPaths = [];
      dependTasks = [];
